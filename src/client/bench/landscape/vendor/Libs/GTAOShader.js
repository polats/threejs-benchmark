// VENDORED from three@0.184.0 examples/jsm/shaders/GTAOShader.js
// (local copy so GTAO can be tuned alongside ./GTAOPass.js).
// Local patch: camera-distance AO fade uniforms for fog-aware early-out.
import {
	DataTexture,
	Matrix4,
	RepeatWrapping,
