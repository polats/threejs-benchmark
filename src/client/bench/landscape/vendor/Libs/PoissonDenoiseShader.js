// VENDORED verbatim from three@0.184.0 examples/jsm/shaders/PoissonDenoiseShader.js
// (local copy so GTAO can be tuned alongside ./GTAOPass.js). No changes.
// Note: the `poissonDisk[i]` dynamic index in the fragment shader's main loop is
// the source of the benign ANGLE/D3D X4000 warning seen on Windows.
import {
	Matrix4,
	Vector2,
	Vector3,
